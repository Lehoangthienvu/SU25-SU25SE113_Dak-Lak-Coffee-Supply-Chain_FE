  ...
  const handleVerify = async () => {
    if (manager) {
      try {
        ...
        setManager((prev) =>
          prev ? { ...prev, isCompanyVerified: !prev.isCompanyVerified } : null
        );
    ...
    return (
      <div className='flex items-center justify-center h-64'>
        ...
        <span className='ml-3 text-gray-600'>
          {t("businessManager.messages.loading")}
        </span>
      </div>
    );
  }
    ...
    return (
      <div className='text-center py-12'>
        <h2 className='text-2xl font-semibold text-gray-900 mb-2'>
          {t("businessManager.detail.notFound")}
        </h2>
        <p className='text-gray-600 mb-4'>
          {t("businessManager.detail.notFoundDesc")}
        </p>
        <Button onClick={() => router.push("/dashboard/admin/managers")}>
          {t("businessManager.detail.backToList")}
        </Button>
      </div>
    );
  }
    ...
    <div className='space-y-6'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <div>
            ...
            <p className='text-gray-600 mt-2'>
              {t("businessManager.detail.subtitle")}
            </p>
          </div>
        </div>
        ...
        <div className='flex gap-2'>
          ...
          <Button variant='outline' asChild>
            <Link href={`/dashboard/admin/managers/${managerId}/edit`}>
              ...
              {t("businessManager.actions.edit")}
            </Link>
          </Button>
          ...
          >
            ...
            {t("businessManager.actions.delete")}
          </Button>
        </div>
      </div>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
        ...
        <div className='lg:col-span-2 space-y-6'>
          ...
          <Card>
            <CardHeader>
              <CardTitle className='flex items-center gap-2'>
                ...
                {t("businessManager.detail.personalInfo")}
              </CardTitle>
            </CardHeader>
            <CardContent className='space-y-4'>
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  <label className='text-sm font-medium text-gray-500'>
                    {t("businessManager.detail.fields.managerCode")}
                  </label>
                  <div className='mt-1'>
                ...
                <div>
                  <label className='text-sm font-medium text-gray-500'>
                    {t("businessManager.detail.fields.status")}
                  </label>
                  <div className='mt-1'>
                    {manager.isCompanyVerified ? (
              ...
              <div>
                <label className='text-sm font-medium text-gray-500'>
                  {t("businessManager.detail.fields.companyName")}
                </label>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  <label className='text-sm font-medium text-gray-500'>
                    {t("businessManager.detail.fields.position")}
                  </label>
                  <p className='mt-1'>
                ...
                <div>
                  <label className='text-sm font-medium text-gray-500'>
                    {t("businessManager.detail.fields.department")}
                  </label>
                  <p className='mt-1'>
          ...
          <Card>
            <CardHeader>
              <CardTitle className='flex items-center gap-2'>
                <Building2 className='w-5 h-5' />
                {t("businessManager.detail.companyInfo")}
              </CardTitle>
            </CardHeader>
            <CardContent className='space-y-4'>
              <div>
                <label className='text-sm font-medium text-gray-500'>
                  {t("businessManager.detail.fields.companyAddress")}
                </label>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  <label className='text-sm font-medium text-gray-500'>
                    {t("businessManager.detail.fields.taxId")}
                  </label>
                  <p className='mt-1 font-mono'>{manager.taxId || "N/A"}</p>
                </div>
                <div>
                  <label className='text-sm font-medium text-gray-500'>
                    {t("businessManager.detail.fields.website")}
                  </label>
                  <p className='mt-1 flex items-center gap-2'>
              ...
              <div>
                <label className='text-sm font-medium text-gray-500'>
                  {t("businessManager.detail.fields.businessLicense")}
                </label>
                <p className='mt-1 flex items-center gap-2'>
          ...
          <Card>
            <CardHeader>
              <CardTitle className='flex items-center gap-2'>
                ...
                {t("businessManager.detail.contactInfo")}
              </CardTitle>
            </CardHeader>
            <CardContent className='space-y-4'>
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  <label className='text-sm font-medium text-gray-500'>
                    {t("businessManager.detail.fields.contactEmail")}
                  </label>
                  <p className='mt-1 flex items-center gap-2'>
                ...
                <div>
                  <label className='text-sm font-medium text-gray-500'>
                    {t("businessManager.detail.fields.phoneNumber")}
                  </label>
                  <p className='mt-1 flex items-center gap-2'>
              ...
              <div>
                <label className='text-sm font-medium text-gray-500'>
                  {t("businessManager.detail.fields.loginEmail")}
                </label>
                <p className='mt-1 flex items-center gap-2'>
                  <Mail className='w-4 h-4 text-gray-400' />
                  {manager.email || "N/A"}
        ...
        <div className='space-y-6'>
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t("businessManager.detail.statistics")}</CardTitle>
            </CardHeader>
            <CardContent className='space-y-4'>
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t("businessManager.detail.systemInfo")}</CardTitle>
            </CardHeader>
            <CardContent className='space-y-3'>
              <div>
                <label className='text-sm font-medium text-gray-500'>
                  {t("businessManager.detail.fields.createdAt")}
                </label>
              ...
              <div>
                <label className='text-sm font-medium text-gray-500'>
                  {t("businessManager.detail.fields.updatedAt")}
                </label>
                <p className='mt-1 text-sm flex items-center gap-2'>
                  <Calendar className='w-4 h-4 text-gray-400' />
