        ...
        <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-4 text-white">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-green-100 text-sm font-medium">{t('warehouseOutboundReceipts.stats.confirmedReceipts')}</p>
                          ...
                          <td className="px-4 py-3 text-center">
                            {isConfirmed ? (
                              <Badge className="bg-green-100 text-green-800 border border-green-200 px-3 py-1 rounded-full">
                                ...
                                {t('warehouseOutboundReceipts.detail.status.confirmed')}
                              </Badge>
                            ) : (
