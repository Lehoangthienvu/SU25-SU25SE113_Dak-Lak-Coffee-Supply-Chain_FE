...
export default function ProcurementPlanDetailPage() {
  ...
  useEffect(() => {
    ...
    getProcurementPlanById(id as string)
      .then(setPlan)
      .catch((err) =>
        setError(err.message || t("procurementPlan.pages.detail.error"))
      )
  ...
  const formatDate = (date?: string) => {
    ...
    return isNaN(d.getTime())
      ? t("procurementPlan.common.notUpdated")
  ...
  if (loading)
    return (
      <div className='text-center py-8'>
        {t("procurementPlan.pages.detail.loading")}
      </div>
    );
  if (error || !plan)
    return (
      ...
      <div className='w-full max-w-6xl space-y-6'>
              ...
              <div className='flex items-center gap-3'>
                ...
                <div>
                  <CardTitle className='text-xl text-orange-800'>
                    {t("procurementPlan.pages.detail.basicInfo.title")}
                  </CardTitle>
                  <p className='text-sm text-orange-600 mt-1'>
                    {t("procurementPlan.pages.detail.basicInfo.code", {
              ...
              {plan.status === "Draft" && (
                <div className='flex gap-2'>
                  ...
                  >
                    ...
                    {t("procurementPlan.pages.detail.basicInfo.edit")}
                  </Button>
                  {/* <Button
                    size='sm'
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
              ...
              <div className='space-y-3'>
                <h4 className='font-semibold text-orange-700 text-sm uppercase tracking-wide'>
                  {t("procurementPlan.pages.detail.sections.basicInfo.title")}
                </h4>
                <div className='space-y-2'>
                  <div className='flex justify-between'>
                    <span className='text-gray-600'>
                      {t(
                        "procurementPlan.pages.detail.sections.basicInfo.title_label"
                      )}
                    </span>
                  ...
                  <div className='flex justify-between'>
                    <span className='text-gray-600'>
                      {t(
                        "procurementPlan.pages.detail.sections.basicInfo.status_label"
                      )}
                    </span>
                  ...
                  <div className='flex justify-between'>
                    <span className='text-gray-600'>
                      {t(
                        "procurementPlan.pages.detail.sections.basicInfo.registrationPeriod_label"
                      )}
                    </span>
                    <span className='font-medium text-gray-800'>
              ...
              <div className='space-y-3'>
                <h4 className='font-semibold text-orange-700 text-sm uppercase tracking-wide'>
                  {t("procurementPlan.pages.detail.sections.output.title")}
                </h4>
                <div className='space-y-2'>
                  <div className='flex justify-between'>
                    <span className='text-gray-600'>
                      {t(
                        "procurementPlan.pages.detail.sections.output.totalOutput_label"
                      )}
                    </span>
                    <span className='font-medium text-gray-800'>
                      {plan.totalQuantity.toLocaleString()}{" "}
                      {t(
                        "procurementPlan.components.procurementPlanCard.units.kilogram"
                      )}
                    </span>
                  </div>
                  <div className='flex justify-between'>
                    <span className='text-gray-600'>
                      {t(
                        "procurementPlan.pages.detail.sections.output.registrationProgress_label"
                      )}
                    </span>
                    <span className='font-medium text-gray-800'>
                      {Number(plan.progressPercentage).toFixed(1)}
                      {t(
                  ...
                  <div className='flex justify-between'>
                    <span className='text-gray-600'>
                      {t(
                        "procurementPlan.pages.detail.sections.output.planDetailsCount_label"
                      )}
                    </span>
                    <span className='font-medium text-gray-800'>
                      {plan.procurementPlansDetails?.length || 0}{" "}
                      {t(
                        "procurementPlan.pages.detail.sections.output.details"
                      )}
                    </span>
                  </div>
                </div>
              ...
              <div className='space-y-3'>
                <h4 className='font-semibold text-orange-700 text-sm uppercase tracking-wide'>
                  {t("procurementPlan.pages.detail.sections.business.title")}
                </h4>
                <div className='space-y-2'>
                  <div className='flex justify-between'>
                    <span className='text-gray-600'>
                      {t(
                        "procurementPlan.pages.detail.sections.business.name_label"
                      )}
                    </span>
                    <span className='font-medium text-gray-800'>
                  ...
                  <div className='flex justify-between'>
                    <span className='text-gray-600'>
                      {t(
                        "procurementPlan.pages.detail.sections.business.address_label"
                      )}
                    </span>
                  ...
                  <div className='flex justify-between'>
                    <span className='text-gray-600'>
                      {t(
                        "procurementPlan.pages.detail.sections.business.email_label"
                      )}
                    </span>
                    <span className='font-medium text-gray-800'>
                      {plan.createdBy?.contactEmail ||
                        t("procurementPlan.common.noData")}
                    </span>
                  </div>
                </div>
            ...
            {plan.description && (
              <div className='mt-6 pt-4 border-t border-orange-200'>
                <h4 className='font-semibold text-orange-700 text-sm uppercase tracking-wide mb-2'>
                  {t("procurementPlan.pages.detail.sections.description.title")}
                </h4>
            ...
            <div className='flex items-center gap-3'>
              ...
              <div>
                <CardTitle className='text-xl text-blue-800'>
                  {t("procurementPlan.pages.detail.planDetails.title")}
                </CardTitle>
                <p className='text-sm text-blue-600 mt-1'>
                  {t("procurementPlan.pages.detail.planDetails.subtitle", {
                    count: plan.procurementPlansDetails?.length || 0,
                  })}
                </p>
              </div>
            </div>
            ...
            plan.procurementPlansDetails.length > 0 ? (
                        ...
                        <div className='flex items-center justify-between'>
                          <div className='flex items-center gap-3'>
                            ...
                            <div>
                              ...
                              <p className='text-sm text-blue-600'>
                                {t(
                                  "procurementPlan.pages.detail.planDetails.detail.coffeeType",
                                  {
                                    coffeeType: detail.coffeeType?.typeName,
                                    processingMethod:
                                      detail.processingMethodName ||
                                      t(
                                        "procurementPlan.common.noProcessingMethod"
                                      ),
                                  }
                                )}
                              </p>
                          ...
                          <div className='text-right text-sm'>
                            <div className='text-gray-500'>
                              {t(
                                "procurementPlan.pages.detail.planDetails.detail.progress"
                              )}
                            </div>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                          ...
                          <div className='space-y-2'>
                            <h5 className='font-medium text-gray-700 text-sm uppercase tracking-wide'>
                              {t(
                                "procurementPlan.pages.detail.planDetails.detail.sections.output.title"
                              )}
                            </h5>
                            <div className='space-y-1 text-sm'>
                              <div className='flex justify-between'>
                                <span className='text-gray-600'>
                                  {t(
                                    "procurementPlan.pages.detail.planDetails.detail.sections.output.target_label"
                                  )}
                                </span>
                              ...
                              <div className='flex justify-between'>
                                <span className='text-gray-600'>
                                  {t(
                                    "procurementPlan.pages.detail.planDetails.detail.sections.output.minRegistration_label"
                                  )}
                                </span>
                                <span className='font-medium'>
                              ...
                              <div className='flex justify-between'>
                                <span className='text-gray-600'>
                                  {t(
                                    "procurementPlan.pages.detail.planDetails.detail.sections.output.registered_label"
                                  )}
                                </span>
                                <span className='font-medium'>
                          ...
                          <div className='space-y-2'>
                            <h5 className='font-medium text-gray-700 text-sm uppercase tracking-wide'>
                              {t(
                                "procurementPlan.pages.detail.planDetails.detail.sections.pricing.title"
                              )}
                            </h5>
                            <div className='space-y-1 text-sm'>
                              <div className='flex justify-between'>
                                <span className='text-gray-600'>
                                  {t(
                                    "procurementPlan.pages.detail.planDetails.detail.sections.pricing.minPrice_label"
                                  )}
                                </span>
                                <span className='font-medium'>
                                  {detail.minPriceRange?.toLocaleString()} VNĐ/
                                  {t(
                                    "procurementPlan.components.procurementPlanCard.units.kilogram"
                                  )}
                                </span>
                              ...
                              <div className='flex justify-between'>
                                <span className='text-gray-600'>
                                  {t(
                                    "procurementPlan.pages.detail.planDetails.detail.sections.pricing.maxPrice_label"
                                  )}
                                </span>
                                <span className='font-medium'>
                                  {detail.maxPriceRange?.toLocaleString()} VNĐ/
                                  {t(
                                    "procurementPlan.components.procurementPlanCard.units.kilogram"
                                  )}
                                </span>
                          ...
                          <div className='space-y-2'>
                            <h5 className='font-medium text-gray-700 text-sm uppercase tracking-wide'>
                              {t(
                                "procurementPlan.pages.detail.planDetails.detail.sections.progress.title"
                              )}
                            </h5>
                            <div className='space-y-1 text-sm'>
                              <div className='flex justify-between'>
                                <span className='text-gray-600'>
                                  {t(
                                    "procurementPlan.pages.detail.planDetails.detail.sections.progress.status_label"
                                  )}
                                </span>
                                <span className='font-medium'>
                                  {detail.status ||
                              ...
                              <div className='flex justify-between'>
                                <span className='text-gray-600'>
                                  {t(
                                    "procurementPlan.pages.detail.planDetails.detail.sections.progress.progress_label"
                                  )}
                                </span>
                                <span className='font-medium'>
                                  {Number(
                        ...
                        {detail.note && (
                          <div className='mt-4 pt-3 border-t border-blue-200'>
                            <h5 className='font-medium text-gray-700 text-sm uppercase tracking-wide mb-2'>
                              {t(
                                "procurementPlan.pages.detail.planDetails.detail.note"
                              )}
                            </h5>
              ...
              <div className='text-center py-8'>
                ...
                <p className='text-muted-foreground text-sm'>
                  {t(
                    "procurementPlan.pages.detail.planDetails.noDetails.title"
                  )}
                </p>
                <p className='text-muted-foreground text-xs mt-1'>
                  {t(
                    "procurementPlan.pages.detail.planDetails.noDetails.subtitle"
                  )}
                </p>
              </div>
            )}
        ...
        <Card className='space-y-4 max-h-[600px] overflow-y-auto'>
          <CardHeader className='flex justify-between items-center'>
            <CardTitle>
              {t("procurementPlan.pages.detail.registrations.title")}
            </CardTitle>
            <CardTitle>
              {t("procurementPlan.pages.detail.registrations.subtitle", {
